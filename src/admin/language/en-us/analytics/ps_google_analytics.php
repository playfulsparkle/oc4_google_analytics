...
$_['heading_setup']                = 'Setting Up Google Analytics 4 (GA4)';
...
$_['text_getting_started']          = '<p><strong>Overview:</strong> The Playful Sparkle - Google Analytics (GA4) Extension for OpenCart 4 allows you to easily integrate Google Analytics 4 (GA4) tracking into your OpenCart store without any coding skills.</p><p><strong>Requirements:</strong> Ensure you have a Google Analytics account, a valid Google Tag ID, and that you’re using a compatible version of OpenCart.</p>';
