...
$_['heading_setup']                = 'Einrichten von Google Analytics 4 (GA4)';
...
$_['text_getting_started']          = '<p><strong>Überblick:</strong> Die Playful Sparkle - Google Analytics (GA4) Erweiterung für OpenCart 4 ermöglicht Ihnen die einfache Integration des Google Analytics 4 (GA4) Trackings in Ihren OpenCart-Shop, ohne dass Programmierkenntnisse erforderlich sind.</p><p><strong>Voraussetzungen:</strong> Stellen Sie sicher, dass Sie ein Google Analytics-Konto, eine gültige Google Tag-ID haben und dass Sie eine kompatible Version von OpenCart verwenden.</p>';
